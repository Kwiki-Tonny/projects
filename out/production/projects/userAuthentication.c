...
*
*Project-Purpose: User Authenctication
*
*Description: A system that verifies user details based upon the Technical Analysis and Design Flow Diagrams
*
*
*/
...
void logIn(){
    ...
    while(attempts<4){
        ...
        if(strcmp(userNameInput, userName)==0 && strcmp(userPasswordInput, userPassword)==0){
            ...
            attempts++;
            printf("Incorrect deatils. You have %d attempt(s) left.\n", 4 - attempts);
        }
    }
...
int main(){
    ...
    do{
        ...
        // switch to direct them to given choice
        switch(choice){
            case 1:
            logIn();
            break;
